...
echo "STA"
echo "==="
grep "timing__setup__ws\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
grep "timing__hold__ws\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
echo
grep "design__max_slew_violation__count\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
grep "design__max_fanout_violation__count\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
grep "design__max_cap_violation__count\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
echo
...
echo
grep Util runs/wokwi/*-openroad-globalplacement/openroad-globalplacement.log
grep util runs/wokwi/71-misc-reportmanufacturability/state_out.json
echo
grep "timing__setup__ws\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
grep "timing__hold__ws\"" runs/wokwi/71-misc-reportmanufacturability/state_out.json
